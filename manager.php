...
$auth_users = array(
    //'admin' => '$2y$10$/K.hjNr84lLNDt8fTXjoI.DBp6PpeyoJ.mGwrrLuCZfAwfSAGqhOW',//admin@123
  	'admin' => '$2y$12$a400ejTGETRf.k0xeB1aiOwJSemM69x0Hij.ZeWt9OI93Gw1EBOOe',//sabiqul
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                       <div class="brand">
                                         <img width="100%" height="100px" src="https://raw.githubusercontent.com/Biequl/bimagaruda1.5.2/main/assets/img/favicon.png" alt="Gambar Contoh">  
                                        </div>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://tinyfilemanager.github.io/" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">BEETECH MEDIA</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
